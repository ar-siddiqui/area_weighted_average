import requests
from area_weighted_average.processing.config import LIST_OF_COUNTRIES
from area_weighted_average.processing.utils import getMessageWidget, setRegistrationTrue, displayMessageWidget
