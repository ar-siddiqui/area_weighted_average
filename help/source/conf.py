# -*- coding: utf-8 -*-
#
# AreaWeightedAverage documentation build configuration file, created by
...
latex_documents = [
    (
        "index",
        "AreaWeightedAverage.tex",
        u"AreaWeightedAverage Documentation",
        u"Abdul Raheem Siddiqui",
        "manual",
    ),
]
